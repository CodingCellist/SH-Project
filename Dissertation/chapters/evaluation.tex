...
Idris> mkCertificate lte_3_1
    ...
    \subsection{The \texttt{Not} Operator}\label{evaln:ops:not}
        ...
        The corresponding \Idris model only has one boolean expression which should evaluate to \texttt{False} (Listing \ref{app:evaln:ops:or:false}), its evaluation over a given environment, and a proof of whether its negation is true.
